...
interface AdminNightRequestFormProps {
...
export function AdminNightRequestForm({
  ...
  return (
    <>
      ...
      {!canSubmit && (
        <p className="text-xs leading-6 text-surface-400">실명과 오늘 끝낼 일을 적어야 신청을 보낼 수 있습니다.</p>
      )}
    </>
  );
}
