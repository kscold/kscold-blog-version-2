...
export function VaultGraphView({
  ...
  return (
    <div
      ref={containerRef}
      className="w-full h-full relative overflow-hidden rounded-[32px] border border-surface-200/50 bg-[#050B14] shadow-inner"
    >
      ...
      {/* Subtle Grid overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none opacity-20 z-0" />
        ...
        nodeCanvasObject={(node: any, ctx, globalScale) => {
          ...
          try {
            ...
            if (showLabel) {
              ...
              ctx.fillStyle = focused ? 'rgba(0, 0, 0, 0.75)' : 'rgba(2, 6, 23, 0.65)';
              ctx.fill();
