...
import { UnifiedTagContainer } from '@/widgets/blog/unified-tag';
...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    title: `#${tag}`,
    description: `${tag} 태그로 묶인 블로그 포스트와 피드 모음입니다.`,
    path: `/tags/${encodeURIComponent(tag)}`,
    keywords: [tag, '태그', '블로그', '피드'],
...
export default async function UnifiedTagPage({
  ...
  return <UnifiedTagContainer tagName={tag} />;
}
